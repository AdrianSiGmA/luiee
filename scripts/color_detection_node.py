...
naranja = np.array([0, 255, 184, 255, 0, 255]) #rojo lab de electronica
...
def main():
    ...
    pub_video = rospy.Publisher('/video_frames', Image, queue_size=10)
    ...
    while not rospy.is_shutdown(): 
        try:
            ...
            if ( ret ):
                ...
                pub_video.publish(br.cv2_to_imgmsg(imgSrc))
                rate.sleep()
